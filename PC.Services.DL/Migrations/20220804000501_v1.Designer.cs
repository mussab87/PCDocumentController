...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Activity", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Approval", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.ApprovalStatus", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Attachment", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Audit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PC.Services.DL.Models.AuthorityMatrix", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.AuthorityMatrixCategoryHeader", b =>
                {
                    b.Property<int>("AuthorityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PC.Services.DL.Models.CategoryHeader", b =>
                {
                    b.Property<int>("CategoryHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Details", b =>
                {
                    b.Property<int>("DetailsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PC.Services.DL.Models.JobTitle", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Levels", b =>
                {
            ...
            modelBuilder.Entity("PC.Services.DL.Models.MainCategory", b =>
                {
                    b.Property<int>("MainCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PC.Services.DL.Models.TrsDetails", b =>
                {
                    b.Property<int>("TrsDetailsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PC.Services.DL.Models.UserJobTitle", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PC.Services.DL.Models.UserMatrix", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PC.Services.DL.Models.UserPassword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PC.Services.DL.Models.UserTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PC.Services.DL.Security.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PC.Services.DL.Security.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Activity", b =>
                {
                    b.HasOne("PC.Services.DL.Security.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("PC.Services.DL.Models.MainCategory", "MainCategory")
                        .WithMany()
                        .HasForeignKey("MainCategoryId");

                    b.HasOne("PC.Services.DL.Security.ApplicationUser", "UpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("PC.Services.DL.Models.Approval", b =>
                {
                    b.HasOne("PC.Services.DL.Security.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("PC.Services.DL.Models.ApprovalStatus", "ApprovalStatus")
                        .WithMany()
                    ...
                    b.HasOne("PC.Services.DL.Models.TrsDetails", "TrsDetails")
                        .WithMany()
            ...
            modelBuilder.Entity("PC.Services.DL.Models.AuthorityMatrixCategoryHeader", b =>
                {
                    b.HasOne("PC.Services.DL.Models.AuthorityMatrix", "AuthorityMatrix")
                        .WithMany("AuthorityMatrixCategoryHeader")
                        .HasForeignKey("AuthorityMatrixAuthorityId");

                    b.HasOne("PC.Services.DL.Models.CategoryHeader", "CategoryHeader")
                        .WithMany("AuthorityMatrixCategoryHeader")
            ...
            modelBuilder.Entity("PC.Services.DL.Models.CategoryHeader", b =>
                {
                    b.HasOne("PC.Services.DL.Models.Activity", "Activity")
                        .WithMany()
                    ...
                    b.HasOne("PC.Services.DL.Models.Details", "Dteails")
                        .WithMany()
            ...
            modelBuilder.Entity("PC.Services.DL.Models.UserJobTitle", b =>
                {
                    ...
                    b.HasOne("PC.Services.DL.Models.JobTitle", "JobTitle")
                        .WithMany("UserJobTitle")
